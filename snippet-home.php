<main class="articles" id="post-<?php echo $this->id; ?>">
	<article class="<?php echo $this->classes ?>">
		...
		<!-- <div class="mobile-only">
			<h4>Nieuw op de kaart</h4>
			<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" width="3em" height="3em" viewBox="0 0 512 512" enable-background="new 0 0 512 512" xml:space="preserve">
